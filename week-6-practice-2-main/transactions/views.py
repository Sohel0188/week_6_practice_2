        ...
        if form.is_valid():
            ...
            if sender.balance >= amount:
                if reciever:
                    ...
                    reciever.save()
                    send_transaction_email(request.user, amount, "Transfer Amount Message", "transactions/transfer_money_mail.html")
                    send_transaction_email(reciever.user, amount, "Transfer Amount Message", "transactions/transfer_money_mail.html")
